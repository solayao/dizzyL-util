...
function _get(_ref) {
  var _ref$base_url = _ref.base_url,
      base_url = _ref$base_url === undefined ? _config.baseUrl : _ref$base_url,
      _ref$port = _ref.port,
      port = _ref$port === undefined ? _config.basePort : _ref$port,
      _ref$path = _ref.path,
      path = _ref$path === undefined ? _config.basePath : _ref$path,
...
function _getWithQueryParams(_ref2) {
  var _ref2$base_url = _ref2.base_url,
      base_url = _ref2$base_url === undefined ? _config.baseUrl : _ref2$base_url,
      _ref2$port = _ref2.port,
      port = _ref2$port === undefined ? _config.basePort : _ref2$port,
      _ref2$path = _ref2.path,
      path = _ref2$path === undefined ? _config.basePath : _ref2$path,
...
function _getWithRequestData(_ref3) {
  var _ref3$base_url = _ref3.base_url,
      base_url = _ref3$base_url === undefined ? _config.baseUrl : _ref3$base_url,
      _ref3$port = _ref3.port,
      port = _ref3$port === undefined ? _config.basePort : _ref3$port,
      _ref3$path = _ref3.path,
      path = _ref3$path === undefined ? _config.basePath : _ref3$path,
...
function _postWithRequestData(_ref4) {
  var _ref4$base_url = _ref4.base_url,
      base_url = _ref4$base_url === undefined ? _config.baseUrl : _ref4$base_url,
      _ref4$port = _ref4.port,
      port = _ref4$port === undefined ? _config.basePort : _ref4$port,
      _ref4$path = _ref4.path,
      path = _ref4$path === undefined ? _config.basePath : _ref4$path,
 ...
 * @returns {Promise.<TResult>|*} Promise.then((data)=>{},(error)=>{})
 */
var myFetch = exports.myFetch = function myFetch(_ref5) {
  var _ref5$base_url = _ref5.base_url,
      base_url = _ref5$base_url === undefined ? _config.baseUrl : _ref5$base_url,
      _ref5$port = _ref5.port,
      port = _ref5$port === undefined ? _config.basePort : _ref5$port,
      _ref5$path = _ref5.path,
      path = _ref5$path === undefined ? _config.basePath : _ref5$path,
