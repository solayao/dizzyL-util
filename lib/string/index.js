 ...
 * @description 转成繁体字
 * @author Dizzy L
 * @param {String} cc 待转换的String
 * @returns {String}  繁体String
 */
var wordTraditionalized = exports.wordTraditionalized = function wordTraditionalized(cc) {
  var str = "",
      ss = JTPYStr(),
      tt = FTPYStr();
 ...
 */
var wordSimplized = exports.wordSimplized = function wordSimplized(cc) {
  var str = "",
      ss = JTPYStr(),
      tt = FTPYStr();
  for (var i = 0; i < cc.length; i++) {
 ...
 * @returns {String}
 */
var fromCamelCase = exports.fromCamelCase = function fromCamelCase(str) {
 ...
 * @returns {String}
 */
var reverseString = exports.reverseString = function reverseString(str) {
