    ...
    _createClass(DBPool, [{
        ...
        value: function sqlAction() {
            ...
            return this.pool.use(function (dbClient) {
                ...
                SuccessConsole('DBpool Message', __filename, 'Release 1 connection, pool.size is ' + _this.pool.size + ', pool.available is ' + _this.pool.available);
                return result;
            }).catch(function (err) {
                return SuccessConsole('DBpool Message', __filename, 'Destroy 1 connection, pool.size is ' + _this.pool.size + ', pool.available is ' + _this.pool.available);
            });
        }
