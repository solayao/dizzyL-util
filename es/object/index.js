import { getPrototypeType } from "../type";
...
export const shallowClone = obj =>
  getPrototypeType(obj) === "Object" ? { ...obj } : {};
 ...
 */
export const allKeyRename = (source, mapper, includeOther = true) =>
  getPrototypeType(source) === "Object" && getPrototypeType(mapper) === "Object"
